...
def main(page: ft.Page):
    ...
    # Mobile ke liye window size hata diya gaya hai. App screen ke hisaab se adjust ho jayegi.
    ...
    chat_list.controls.append(ft.Text("🤖 Nifty Guru: Namaste! Main aapka AI trading mentor hoon.", size=12, color=ft.colors.CYAN_200))
    ...
    # Note: Mobile par threading kabhi-kabhi crash karwa deti hai agar exception handle na ho, isliye try/except mein daala hai
    try:
